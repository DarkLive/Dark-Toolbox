...
namespace Dark_Toolbox {
    public partial class ToolCPUCore {
        ...
        public void SetTimer(object sender, RoutedEventArgs e) {
            ...
            if ( cpucore == 1 ) cpupoint = 1;
            else if ( cpucore == 2 ) cpupoint = 3;
            else if ( cpucore == 3 ) cpupoint = 7;
            else if ( cpucore == 4 ) cpupoint = 15;
            else if ( cpucore == 5 ) cpupoint = 31;
            else if ( cpucore == 6 ) cpupoint = 63;
            else if ( cpucore == 7 ) cpupoint = 127;
            else if ( cpucore == 8 ) cpupoint = 255;
            else {
        ...
        private void itemtoright_Click(object sender, RoutedEventArgs e) { rightlist.Items.Add(leftlist.SelectedItem); leftlist.Items.Remove(leftlist.SelectedItem);  }

        private void itemtoleft_Click(object sender, RoutedEventArgs e) { leftlist.Items.Add(rightlist.SelectedItem); rightlist.Items.Remove(rightlist.SelectedItem); }

        private void clearbutton_Click(object sender, RoutedEventArgs e) { leftlist.Items.Clear(); rightlist.Items.Clear(); }
        ...
        private void timer_Tick(object sender, EventArgs e) {
            ...
            while ( r < allprocess.Length ) {
                ...
                r++;
                if ( keepfly.IsChecked == true ) if ( status.Content == "ON" ) { isolateonleft(); isolateonright(); }
            }
        }
    }
}
